...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener, SensorEventListener {
    ...
    private boolean tilt = false, image = false;
    ...
    public void onButtonCameraImage(View v){
    ...
    public void saveImage(){
        //ImpressionistView impressionistView = (ImpressionistView) findViewById(R.id.viewImpressionist);
        Bitmap bitmap = _impressionistView.get_offScreenBitmap();
        String img = MediaStore.Images.Media.insertImage(getContentResolver(), bitmap, UUID.randomUUID().toString()+".png", "Impression");
    ...
    public void onToggle (View v) {
        //ImpressionistView impressionistView = (ImpressionistView) findViewById(R.id.viewImpressionist);
        _impressionistView.flipToggle();
    }

    @Override
    public void onSensorChanged(SensorEvent sensorEvent) {
        float d = sensorEvent.values[0];
        float r = sensorEvent.values[1];
        //ImpressionistView impressionistView = (ImpressionistView) findViewById(R.id.viewImpressionist);

        if (tilt && image) {
            _impressionistView.sensorMove(r, d);
